/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8ddb803a640ded44afeab676c16a0bb6)
...
interface __BaseEnv_Env {
	...
	ASSETS: Fetcher;
	TURNSTILE_SITEKEY: "0x4AAAAAAEDHe_7gFRNRsdEc";
	TURNSTILE_HOSTNAMES: "justfuckingusecloudflare.com,justfuckingusecloudflare.mynameistito.workers.dev";
	TURNSTILE_SECRET: string;
	DEMO_QUOTA: DurableObjectNamespace<import("./worker/index").DemoQuota>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "DemoQuota";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "TURNSTILE_SITEKEY" | "TURNSTILE_HOSTNAMES" | "TURNSTILE_SECRET">> {}
}
