import { Brain, Database, Globe, Link, Package, Zap } from "lucide-react";
      ...
      <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
        {cards.map((card) => (
          ...
          >
            ...
            <p className="mb-6 min-h-[80px] text-neutral-400 text-sm leading-relaxed md:h-20 md:text-base">
              {card.desc}
            </p>
